...
**Character:** Jost is a geometric sans with a light, modern, slightly editorial feel. Used almost exclusively at weights 200–300, it keeps the interface calm and premium; the entire hierarchy is built from _size and space_, not from heavy weights. Blacker (a serif) and Moniqa are the contrast faces available when a heading needs an editorial voice; pair on the serif↔sans axis, never introduce a second geometric sans.
