  ...
  return (
    ...
    >
      <AnimatePresence initial={false}>
        <motion.div
          className="absolute top-0 z-30 m-auto h-full w-px bg-gradient-to-b from-transparent from-[5%] via-blue-600 to-transparent to-[95%]"
          style={{
            left: `${sliderXPercent}%`,
            top: '0',
            zIndex: 40,
        ...
        >
          <div className="absolute left-0 top-1/2 z-20 h-full w-36 -translate-y-1/2 bg-gradient-to-r from-purple-300 via-transparent to-transparent opacity-50 [mask-image:radial-gradient(100px_at_left,white,transparent)]" />
